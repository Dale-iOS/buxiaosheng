...
@interface ChooseAddressVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,ChooseLablesCollectionReusableViewDelegate,UITextFieldDelegate>
...
- (void)setupUI
{
    ...
    flowLayout.itemSize = CGSizeMake(70, 29);
