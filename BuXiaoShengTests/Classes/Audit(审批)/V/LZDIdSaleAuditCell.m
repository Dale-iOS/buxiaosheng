...
@implementation LZDIdSaleAuditCell
...
- (void)setModel:(LZMarketModel *)model{
    ...
    self.demandLabel.text = [NSString stringWithFormat:@"需求量：%@",_model.number];
    self.priceLabel.text = [NSString stringWithFormat:@"金额：￥%@",_model.price];
