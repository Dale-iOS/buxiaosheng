...
@implementation LZDidNoBackOrderCell
...
- (void)setupUI{
    ...
    [self.priceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.demandLabel.mas_bottom).offset(8);
        make.left.equalTo(self.iconImageView.mas_right).offset(15);
        make.height.mas_offset(13);
        make.width.mas_offset(250);
    }];
...
- (void)setModel:(LZNoBackOrderModel *)model{
    ...
    self.subLabel.text = [NSString stringWithFormat:@"%@",_model.customerName];
    ...
    self.priceLabel.text = [NSString stringWithFormat:@"金额：￥%@",_model.copewithPrice];
