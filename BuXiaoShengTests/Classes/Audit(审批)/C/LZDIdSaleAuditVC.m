...
#import "LZDIdSaleAuditCell.h"
#import "LZMarketModel.h"

@interface LZDIdSaleAuditVC ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray <LZMarketModel *> *lists;

@end

@implementation LZDIdSaleAuditVC
...
{
    static NSString *cellID = @"LZDIdSaleAuditCellId";
    LZDIdSaleAuditCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    
    if (cell == nil) {
        
        cell = [[LZDIdSaleAuditCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
    }
