...
@interface NeedColorDetailCell : UITableViewCell<UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (nonatomic, strong) LZCustomerNeedsDetailProductColorListModel *colorListModel;
