...
@implementation NeedColorDetailCell
...
- (void)awakeFromNib {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"NeedXiMaCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:@"NeedXiMaCollectionViewCell"];
    //[self.collectionView setBackgroundColor:[UIColor clearColor]];
    self.collectionView.scrollEnabled = NO;
    
}

- (void)setColorListModel:(LZCustomerNeedsDetailProductColorListModel *)colorListModel
{
    ...
    _priceLabel.text = colorListModel.number;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    static NSString * cellId = @"NeedXiMaCollectionViewCell";
    NeedXiMaCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellId forIndexPath:indexPath];
