...
@interface ReColorDetailCell : UITableViewCell<UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (nonatomic, strong) LZPurchaseReceivingListDetailProductColorListModel *colorListModel;
