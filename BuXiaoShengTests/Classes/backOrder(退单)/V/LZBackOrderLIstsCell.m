...
@implementation LZBackOrderLIstsCell
...
- (void)setModel:(LZBackOrderListsModel *)model
{
    _model = model;
    ...
    self.priceLabel.text = [NSString stringWithFormat:@"￥：%@",_model.copewithPrice];
