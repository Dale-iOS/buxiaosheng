...
@interface OrderColorDetailCell : UITableViewCell<UICollectionViewDelegate,UICollectionViewDataSource>
...
@property (nonatomic, strong) LZOutOrderProductColorListModel *colorListModel;
