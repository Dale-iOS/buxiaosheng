//
//  LZJGpurchasingInfoDetailVC.m
//  BuXiaoSheng
//
//  Created by 罗镇浩 on 2018/9/12.
...
@interface LZJGpurchasingInfoDetailVC ()<UITableViewDelegate,UITableViewDataSource,WMRefreshCellDelegate>
...
@implementation LZJGpurchasingInfoDetailVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        JGPurchaseDetailCell *cell = [tableView dequeueReusableCellWithIdentifier:@"JGPurchaseDetailCell"];
        if (!cell) {
            cell = [[[NSBundle mainBundle] loadNibNamed:@"JGPurchaseDetailCell" owner:self options:nil] lastObject];
