...
-(PieChartView *)pieChartView {
    if (!_pieChartView) {
       ...
       _pieChartView.delegate = self;
        ...
        _pieChartView.drawCenterTextEnabled = false;//是否显示区块文本
        _pieChartView.drawHoleEnabled = false;//饼状图是否是空心
        _pieChartView.holeRadiusPercent = 0.1;//空心半径占比
        _pieChartView.holeColor = [UIColor clearColor];//空心颜色
        _pieChartView.transparentCircleRadiusPercent = 0.0;//半透明空心半径占比
