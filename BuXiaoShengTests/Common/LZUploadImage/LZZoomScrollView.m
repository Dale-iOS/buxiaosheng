...
@interface LZZoomScrollView (Utility)

- (CGRect)zoomRectForScale:(float)scale withCenter:(CGPoint)center;

@end

@implementation LZZoomScrollView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.delegate = self;
        self.frame = CGRectMake(frame.origin.x, 0, MRScreenWidth, CGRectGetHeight(frame));
        self.contentSize = CGSizeMake(MRScreenWidth, CGRectGetHeight(frame));
...
- (void)initImageView
{
    ...
    imageView.frame = CGRectMake(0, 0, MRScreenWidth, CGRectGetHeight(self.frame));
