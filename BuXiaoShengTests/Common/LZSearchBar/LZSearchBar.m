...
@interface LZSearchBar()<UITextFieldDelegate>
{
    UITextField *_textField;
    UIImageView *_iconView;
    UIImageView *_iconCenterView;
    LZSearchBarIconAlign _iconAlignTemp;
}
...
-(void)buidView{
    ...
    _textField = ({
        ...
        textField.layer.borderColor = [LZHBackgroundColor CGColor];
...
-(void)setIconAlign:(LZSearchBarIconAlign)iconAlign{
    if(!_iconAlignTemp){
...
-(void)ajustIconWith:(LZSearchBarIconAlign)iconAlign{
    if (_iconAlign == LZSearchBarIconAlignCenter) {
...
{
    if(_iconAlignTemp == LZSearchBarIconAlignCenter){
        self.iconAlign = LZSearchBarIconAlignLeft;
    }
...
{
    if(_iconAlignTemp == LZSearchBarIconAlignCenter){
        self.iconAlign = LZSearchBarIconAlignCenter;
    }
