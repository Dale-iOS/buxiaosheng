...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Addition/Addition.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/CWLateralSlide/CWLateralSlide.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Charts/Charts.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EasyNavigation/EasyNavigation.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TZImagePreviewController/TZImagePreviewController.framework"
