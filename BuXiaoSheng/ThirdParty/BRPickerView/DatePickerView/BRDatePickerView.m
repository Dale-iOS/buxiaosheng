...
#ifdef DEBUG
        NSLog(@"1最小时间date：%@", self.minLimitDate);
        NSLog(@"1默认时间date：%@", self.selectDate);
        NSLog(@"1最大时间date：%@", self.maxLimitDate);
        
        NSLog(@"2最小时间：%@", [NSDate br_getDateString:self.minLimitDate format:self.selectDateFormatter]);
        NSLog(@"2默认时间：%@", [NSDate br_getDateString:self.selectDate format:self.selectDateFormatter]);
        NSLog(@"2最大时间：%@", [NSDate br_getDateString:self.maxLimitDate format:self.selectDateFormatter]);
#endif
